...
\begin{itemize}
    ...
    \item \textit{U} - a set of information states (one for each player).
...
for every player) then that game constitutes a Nash equilibrium\cite{heinrich2017reinforcement}.
