...
Finally on lines 26 to 29 the next state is generated, the SIMULATE function is recursively
called and when this recursion ends the UPDATE function is called in order to update the
value and visitation count of $u^{i}$ and it's child node.
