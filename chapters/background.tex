...
Rather than four rounds there are ony two.
In the first round a single private card is dealt to each player.
In the second round a single board card is revealed.
In the first round both players have a mandatory bet of one and a raise of 2 is allowed.
In the second round players can raise by at most 4.
